...
def test_greedy_ai(num_games=20, max_moves=2000, save_path=None):
    """测试贪婪AI并可选保存结果"""
    print("\n开始测试贪婪AI...")
...
def test_mcts_ai(num_games=20, max_moves=2000, simulation_time=0.2, save_path=None):
    """测试MCTS AI并可选保存结果"""
    print("\n开始测试MCTS AI...")
...
def test_ml_ai(num_games=20, max_moves=2000, save_path=None):
    """测试ML增强AI并可选保存结果"""
    print("\n开始测试ML增强AI...")
